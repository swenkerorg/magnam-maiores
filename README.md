<div align="center">
  ...
  <h3>@swenkerorg/magnam-maiores</h3>
...
[![Continuous integration](https://github.com/swenkerorg/magnam-maiores/workflows/Continuous%20integration/badge.svg)](https://github.com/swenkerorg/magnam-maiores/actions?query=workflow%3A%22Continuous+integration%22) [![@swenkerorg/magnam-maiores](https://img.shields.io/npm/v/@swenkerorg/magnam-maiores.svg?label=@swenkerorg/magnam-maiores&logo=npm)](https://www.npmjs.com/package/@swenkerorg/magnam-maiores)

<i>Quickly check for compliance? Visit <b>[@swenkerorg/magnam-maiores.com](https://@swenkerorg/magnam-maiores.com)</b>!</i>
...
```shell
yarn add @swenkerorg/magnam-maiores
```
...
import { createHandler } from '@swenkerorg/magnam-maiores/lib/use/http';
...
import { createHandler } from '@swenkerorg/magnam-maiores/lib/use/http2';
import { schema } from './previous-step';
...
import { createHandler } from '@swenkerorg/magnam-maiores/lib/use/express';
import { schema } from './previous-step';
...
import { createHandler } from '@swenkerorg/magnam-maiores/lib/use/fastify';
import { schema } from './previous-step';
...
import { createHandler } from '@swenkerorg/magnam-maiores/lib/use/koa';
import { schema } from './previous-step';
...
import { createHandler } from '@swenkerorg/magnam-maiores/lib/use/uWebSockets';
import { schema } from './previous-step';
...
import { createHandler } from 'https://esm.sh/@swenkerorg/magnam-maiores/lib/use/fetch';
import { schema } from './previous-step';
...
```js
import { createHandler } from '@swenkerorg/magnam-maiores/lib/use/fetch'; // bun install @swenkerorg/magnam-maiores
import { schema } from './previous-step';
...
```js
import { createHandler } from '@swenkerorg/magnam-maiores/lib/use/@netlify/functions'; // yarn add @netlify/functions
import { schema } from './previous-step';
...
```js
import { createClient } from '@swenkerorg/magnam-maiores';
...
import { createClient, RequestParams } from '@swenkerorg/magnam-maiores';
...
import { createClient, ClientOptions, Client } from '@swenkerorg/magnam-maiores';
import { getSession } from './my-auth';
...
```ts
import { createClient, NetworkError } from '@swenkerorg/magnam-maiores';
...
<html>
  <head>
    ...
    <script
      ...
      src="https://unpkg.com/@swenkerorg/magnam-maiores/umd/@swenkerorg/magnam-maiores.min.js"
    ></script>
  </head>
  <body>
...
const { createClient } = require('@swenkerorg/magnam-maiores');
...
```js
import { createClient } from 'https://esm.sh/@swenkerorg/magnam-maiores';
...
```js
import { createClient } from '@swenkerorg/magnam-maiores'; // bun install @swenkerorg/magnam-maiores
...
Authenticate the user within `@swenkerorg/magnam-maiores` during GraphQL execution context assembly. This is a approach is less safe compared to early authentication ([see early authentication in Node](#auth-node-early)) because some GraphQL preparations or operations are executed even if the user is not unauthorized.

```js
import { createHandler } from '@swenkerorg/magnam-maiores';
import {
  schema,
  getUserFromCookies,
...
Authenticate the user early, before reaching `@swenkerorg/magnam-maiores`. This is the recommended approach because no GraphQL preparations or operations are executed if the user is not authorized.
...
import { serverAudits } from '@swenkerorg/magnam-maiores';
...
```ts
import { serverAudits } from 'npm:@swenkerorg/magnam-maiores';
...
Having said this, @swenkerorg/magnam-maiores is mostly aimed for library authors and simple server setups, where the requirements are exact to what the aforementioned spec offers.
